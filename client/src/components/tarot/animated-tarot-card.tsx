  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Card Front */}
        <div 
          className={`absolute w-full h-full backface-hidden rounded-lg shadow-lg border border-gold/30 overflow-hidden rotate-y-180 ${hasGlowEffect ? 'animate-subtle-pulse' : ''}`}
          style={{ 
            zIndex: isFlipped ? 1 : -1,
